...
#ifdef ZQ_TEST_BUILD
# define ZQ_ASSERT(expr) ZQ_SGMT_BEGIN if (expr) {} else { ::Ziqe::Utils::Logger::logError (#expr " Failed"); } ZQ_SGMT_END

# define ZQ_ASSERT_REPORT(expr, msg) ZQ_SGMT_BEGIN if (expr) {} else { ::Ziqe::Utils::Logger::logWarning (#expr " Failed: " msg); } ZQ_SGMT_END
# define ZQ_ASSERT_REPORT_NOT_REACHED(msg) ::Ziqe::Utils::Logger::logWarning ("Reached: " msg)
