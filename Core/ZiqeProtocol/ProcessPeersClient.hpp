...
class ProcessPeersClient : private MessageStream
{
public:
...
private:
     ...
     * @param vector
     */
    bool sendThreadMessage (GlobalThreadID threadID, OutputDataType &&vector)
    {
    ...
    /**
     * @brief mOurPort  This client's connection.
     *
     * Every client should have a port it listen to when it need
     * a response.
     */
    Base::UniquePointer<Net::NetworkProtocol> mOurPort;
};
