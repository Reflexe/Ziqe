...
public:
    ...
    static MessageContainer makeVector (Message::Type type, Args&&...args) {
        ...
        return std::move (writer.getVector().getVector ());
    }
    ...
    static MessageContainer makeRunThreadPeerLookup (IdentiferType identifer)
    {
    ...
    // TODO
    static MessageContainer makeRunThreadPeerPropose (IdentiferType identifer)
    {

    }

    static MessageContainer makeRunThreadPeerAcceptPropose (IdentiferType identifer);
};
