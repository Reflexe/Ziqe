...
/**
   ...
   @todo Split to client and server.
 */
class GlobalPeers
{
public:
     ...
     */
    Base::Expected<Base::Pair<OwnedThread, OwnedProcess>, RunThreadError> runThread(const LocalThread &localThread);
...
private:
    ...
    void waitForTask (Task &task, Protocol::MessageServer &server) {
