...
enum
{
    ...
    kIOMemoryPurgeableVolatileGroup0           = 0,
    kIOMemoryPurgeableVolatileGroup1           = 0,
    kIOMemoryPurgeableVolatileGroup2           = 0,
    kIOMemoryPurgeableVolatileGroup3           = 0,
    kIOMemoryPurgeableVolatileGroup4           = 0,
    kIOMemoryPurgeableVolatileGroup5           = 0,
    kIOMemoryPurgeableVolatileGroup6           = 0,
    kIOMemoryPurgeableVolatileGroup7           = 0,
    kIOMemoryPurgeableVolatileBehaviorFifo     = 0,
    kIOMemoryPurgeableVolatileBehaviorLifo     = 0,
    kIOMemoryPurgeableVolatileOrderingObsolete = 0,
    kIOMemoryPurgeableVolatileOrderingNormal   = 0,
    kIOMemoryPurgeableFaultOnAccess            = 0,
};
enum
{
